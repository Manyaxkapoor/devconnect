...
import { Mail, Lock, Github, LogIn, User } from 'lucide-react';
  ...
  return (
    <div className="max-w-md w-full mx-auto bg-white rounded-2xl shadow-xl p-8 font-sans">
      <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
        <LogIn size={22} className="text-primary-600" /> Login to DevConnect
      </h2>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-black/30" type="button" aria-label="Login with Google">
          <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" className="w-5 h-5" />
          Google
        </button>
        <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-black/30" type="button" aria-label="Login with GitHub">
          <Github size={18} />
          GitHub
        </button>
      </div>
      <div className="mt-6 text-center text-sm text-gray-500">
        Don&apos;t have an account? <a href="#signup" className="text-primary-600 font-medium hover:underline">Sign up</a>
      </div>
    </div>
  );
};
